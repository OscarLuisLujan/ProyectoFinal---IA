...
new_form = """
                <form id="evaluation-form" class="evaluation-form">
                    ...
                    <div class="tabs-header">
                        <button type="button" class="tab-btn active">Información General</button>
                        <button type="button" class="tab-btn">Estado Estructural</button>
                        <button type="button" class="tab-btn">Humedad y Drenaje</button>
                        <button type="button" class="tab-btn">Terreno y Topografía</button>
                        <button type="button" class="tab-btn">Entorno y IA</button>
                    </div>
                    ...
                    <div class="tab-content" id="tab-4">
                        ...
                        <div class="ia-subgroup" style="margin-top: 1rem;">
                    ...
                    <div class="form-navigation">
                        <button type="button" id="btn-prev" class="btn-nav" disabled>Anterior</button>
                        <button type="button" id="btn-next" class="btn-nav">Siguiente</button>
                        <button type="submit" id="btn-submit" class="btn-submit hidden">
...
if match:
    ...
    with open(html_file, 'w', encoding='utf-8') as f:
        f.write(content)
    print('HTML Restaurado exitosamente.')
else:
